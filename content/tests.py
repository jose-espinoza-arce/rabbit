...
from content.models import Advertiser, AdCategory, AdZone, AdBase
from content.models import AdImpression, AdClick
from content.managers import AdManager
from content.templatetags.adzone_tags import random_zone_ad, random_category_ad
