...
class ClientIndexDashboard(Dashboard):
    columns = 2
...
class ClientAppIndexDashboard(AppIndexDashboard):
    def init_with_context(self, context):
...
class ManagerAppIndexDashboard(ClientAppIndexDashboard):
    pass

class ManagerIndexDashboard(ClientIndexDashboard):
    def init_with_context(self, context):
        super(ManagerIndexDashboard, self).init_with_context(context)
