    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(related_name='child', blank=True, to='adzone.AdCategory', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='BannerAd',
            fields=[
                ('adbase_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='adzone.AdBase')),
        ...
        migrations.AddField(
            ...
            name='ad',
            field=models.ForeignKey(to='adzone.AdBase'),
        ),
        migrations.AddField(
            model_name='adclick',
            name='ad',
        ...
        migrations.AddField(
            model_name='adbase',
            name='advertiser',
            field=models.ForeignKey(verbose_name='Ad Provider', to='adzone.Advertiser'),
        ),
        migrations.AddField(
            model_name='adbase',
            name='category',
            field=models.ForeignKey(verbose_name='Category', blank=True, to='adzone.AdCategory', null=True),
        ),
        migrations.AddField(
            model_name='adbase',
            name='type',
            field=models.ForeignKey(verbose_name='Type', blank=True, to='adzone.AdType', null=True),
        ),
    ]
